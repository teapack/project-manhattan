...
public class Vehicle implements IVehicle, IListener {
    ...
    private final int BLINKING_SPEED = 5; // default: 5; The higher this number
    // is, the lower the blinking speed is!
    ...
    public void blinkLeft() {
        if (!isBlinking()) {
            ...
            imageUrl = DataPkg.class.getResource("vehicle_left.png");
            setImage(imageUrl);
        }
    }
    ...
    public void blinkRight() {
        if (!isBlinking()) {
            ...
            imageUrl = DataPkg.class.getResource("vehicle_right.png");
            setImage(imageUrl);
        }
    }
